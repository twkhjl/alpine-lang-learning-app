(function (root, factory) {
  ...
  const DICTIONARY = {
    "zh-TW": {
      ...
      "words.actions.deleteSelected": "刪除已選項目",
      ...
      "words.status.deletingOne": "刪除單字中...",
      "words.status.deleteOneError": "刪除單字失敗。",
      "words.status.deletingBatch": "批次刪除單字中...",
      "words.status.deleteBatchError": "批次刪除單字失敗。",
      ...
      "common.close": "關閉",
      "common.confirm": "確認",
      "feedback.confirm.assetDeleteMessage": "確定要刪除 {key} 嗎？",
      "feedback.confirm.deleteTitle": "確認刪除",
      "feedback.confirm.purgeMessage": "這會刪除整個 R2 bucket 並同步清空資料庫媒體欄位，確定繼續？",
      "feedback.confirm.purgeTitle": "確認清空素材",
      "feedback.confirm.tagDeleteMessage": "確定要刪除這個標籤嗎？",
      "feedback.confirm.wordDeleteMessage": "刪除這個單字後，圖片與音檔也會一併刪除。確定要繼續嗎？",
      "feedback.confirm.wordAudioDeleteMessage": "確定要刪除 {languageCode} 音檔嗎？",
      "feedback.confirm.wordImageDeleteMessage": "確定要刪除這張圖片嗎？",
      "words.toast.deleteOneSuccess": "單字已刪除。",
      "words.toast.deleteOneSuccessWithMedia": "單字已刪除，並清除 {objectCount} 個媒體檔案。",
      "words.toast.deleteOneError": "刪除單字失敗。",
      "words.toast.deleteBatchSuccess": "已刪除 {count} 筆單字。",
      "words.toast.deleteBatchSuccessWithMedia": "已刪除 {count} 筆單字，並清除 {objectCount} 個媒體檔案。",
      "words.toast.deleteBatchError": "批次刪除單字失敗。",
      "words.toast.deleteOnePartialError": "單字已刪除，但 {objectCount} 個媒體檔案尚未刪除乾淨，請檢查資產。",
      "words.toast.deleteBatchPartialError": "已刪除 {count} 筆單字，但 {objectCount} 個媒體檔案尚未刪除乾淨，請檢查資產。",
      ...
      "wordEdit.toast.audioDeleteError": "{languageCode} 音檔刪除失敗。",
      "wordEdit.toast.audioDeleteSuccess": "{languageCode} 音檔已刪除。",
      "wordEdit.toast.audioUploadError": "{languageCode} 音檔上傳失敗。",
      "wordEdit.toast.audioUploadSuccess": "{languageCode} 音檔已上傳。",
      "wordEdit.toast.imageDeleteError": "圖片刪除失敗。",
      "wordEdit.toast.imageDeleteSuccess": "圖片已刪除。",
      "wordEdit.toast.imageUploadError": "圖片上傳失敗。",
      "wordEdit.toast.imageUploadSuccess": "圖片已上傳。",
    },
    en: {
      ...
      "words.actions.deleteSelected": "Delete Selected",
      ...
      "words.status.deletingOne": "Deleting word...",
      "words.status.deleteOneError": "Failed to delete word.",
      "words.status.deletingBatch": "Deleting selected words...",
      "words.status.deleteBatchError": "Failed to delete selected words.",
      ...
      "feedback.confirm.assetDeleteMessage": "Delete {key}?",
      "feedback.confirm.deleteTitle": "Confirm Deletion",
      "feedback.confirm.purgeMessage": "This removes every object from the R2 bucket and clears matching database media fields. Continue?",
      "feedback.confirm.purgeTitle": "Confirm Bucket Purge",
      "feedback.confirm.tagDeleteMessage": "Delete this tag?",
      "feedback.confirm.wordDeleteMessage": "Delete this word? Its image and audio files will also be deleted.",
      "feedback.confirm.wordAudioDeleteMessage": "Delete the {languageCode} audio file?",
      "feedback.confirm.wordImageDeleteMessage": "Delete the current image?",
      ...
      "wordEdit.toast.deleteSuccessWithMedia": "Word deleted and {objectCount} media files removed.",
      "wordEdit.toast.deletePartialError": "Word deleted, but {objectCount} media files still need cleanup.",
      "wordEdit.toast.audioDeleteError": "{languageCode} audio delete failed.",
      "wordEdit.toast.audioDeleteSuccess": "{languageCode} audio deleted.",
      "wordEdit.toast.audioUploadError": "{languageCode} audio upload failed.",
      "wordEdit.toast.audioUploadSuccess": "{languageCode} audio uploaded.",
      "wordEdit.toast.imageDeleteError": "Image delete failed.",
      "wordEdit.toast.imageDeleteSuccess": "Image deleted.",
      "wordEdit.toast.imageUploadError": "Image upload failed.",
      "wordEdit.toast.imageUploadSuccess": "Image uploaded.",
    },
  };
